...
<div class="container">
    ...
    <form action="/garage" enctype="multipart/form-data" method="post">
            ...
            <div class="col-8 offset-2">
                ...
                <div class="form-group row">
                                <label for="model" class="col-md-4 col-form-label ">model</label>
                                    ...
                                    <input id="model"  type="text" class="form-control @error('model') is-invalid @enderror" name="model" value="{{ old('model') }}"  autocomplete="model" autofocus>
                ...
                <div class="form-group row">
                                <label for="year" class="col-md-4 col-form-label ">year</label>
                                    ...
                                    <input id="year" type="number" min="1900" max="2020" value="2020" class="form-control @error('year') is-invalid @enderror" name="year" value="{{ old('year') }}"  autocomplete="year" autofocus>
